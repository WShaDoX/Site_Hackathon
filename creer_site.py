...
<head>
    ...
    <style>
        ...
        .logo {max-width:200px; margin:15px auto; display:block;}
        nav {background:#1b5e20; padding:15px; text-align:center;}
        nav a {color:white; margin:0 25px; text-decoration:none; font-weight:bold;}
        nav a:hover {color:#c8e6c9;}

        /* 2. Suppression de tout filtre de couleur (y compris le filtre sombre) */
        .hero {color:green; padding:100px 20px; text-align:center;
               /* Ajout d'une ombre de texte pour améliorer la lisibilité sur l'image */
               text-shadow: 2px 2px 5px rgba(0,0,0,0.8);}

        section {max-width:1100px; margin:30px auto; background:white; padding:30px; border-radius:12px; box-shadow:0 5px 20px rgba(0,0,0,0.1);}
        ...
        .logo-footer {max-width:130px; margin:15px auto; display:block;}
    </style>
</head>
<body>
    ...
    <section id="fonctionnement">
        ...
        <p>27 % des besoins couverts par la géothermie.  
           Puis la chaudière biomasse prend le relais automatiquement.</p>
    </section>
